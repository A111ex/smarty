...
<body>
  <header><div class="container">
	<div class="logo">Юридическая помощь в Краснодаре<br />по выписке и выселению</div>
...
<section class="s0"><a name="s0"></a>
	<div class="content container">
		<div class="caption"><div>Выписка из квартиры через суд<br/>от 4900 за 2 месяца</div></div>
	...
	<div class="container">
	  ...
	  <div class="caption">Узнайте, какие катастрофические<br/>последствия влечет ваше бездействие</div>
		<div class="list">
			<ul>
				<li>
				  <p>Незаконное завладение вашей квартирой в будущем</p>
				</li>
				<li>
				  <p>Невозможность продать квартиру с прописанными людьми</p>
				</li>
				<li>
				  <p>Огромная переплата за коммунальные расходы</p>
				</li>
				<li>
				  <p>Реальное вселение в вашу квартиру прописанных лиц в любой момент</p>
				</li>
				<li>
				  <p>Обязанность обеспечить отдельным жильем прописанных лиц</p>
				</li>
			</ul>
		</div>
 ...
 <section class="s2"><a name="s2"></a>
	<div class="container landingItem" id="link_uslug">
		...
		<div class="itemp">
			...
			<div class="plashka1">69 000 руб.</div>
		</div>
		...
		<div class="itemp itemp1">
			...
			<div class="plashka1"><p>36 000 руб.</p>27 700 руб.</div>
		...
		<div class="itemp itemp2">
			...
			<div class="plashka1"><!-- <p>50 000 руб.</p> -->4 900 руб.</div>
		</div>
	...
	<div class="container">
		...
		<div class="slides">
			<div class="slides_container">
				<div class="item">
					<div class="foto"><img src="images/book_format.jpeg" width="241" height="300" alt=""/>Стороженко Ольга<br/>8-903-411-37-37</div>
					<div class="caption2">Чуть не остались на улице!<br>
											Вовремя выселили аферистов и сохранили квартиру.
					</div>
					<div class="text">К адвокату Епифановой наша семья обратилась в отчаянии, когда аферисты через родственника сделали дарственную на нашу квартиру и уже жили в ней с пропиской. В полиции только руками разводили, мол раньше надо было думать. Мы  в любой момент могли остаться на улице и не знали что делать.<br>
					...
					<div class="button"><a href="address.html">Подробнее<br/>о деле</a></div>
				</div>
				  <div class="item">
					<div class="foto"><img src="images/no_foto1.jpg" width="241" height="300" alt=""/>Степанов Валерий Петрович</div>
					<div class="caption2">Избавили от огромной коммуналки за непроживающую дочь.</div>
					<div class="text">Еще в 2001 году я прописал в своем доме взрослую дочь, у которой тогда не было своего жилья. Дочь давно переехала в другой город, а я до сих пор вынужден со своей пенсии платить за нее коммуналку, ведь квитанции и на нее приходят. Вот и пришел к юристам.<br>
					...
					<div class="button"><a href="address_2.html">Подробнее<br/>о деле</a></div>
				  </div>
				 </div>
...
<script src="js/main.js"></script>
  ...
  $(".s2 .itemp").each(function(index, element) {
    if (_h<$(this).height()) {_h=$(this).height();}
});
$(".s2 .itemp").height(_h);  
//растяжка в секции 4
  var _h=0;

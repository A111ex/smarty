...
$arResult = array(
    ...
    'h1' => $h1,
    'caption' => array(
        'Взыскать задолженность с ИП, юр/лиц',
        'Взыскать неосновательное обогащение',
        'Взыскать неустойку, проценты',
        'Оспорить право собственности',
        'Признать право собственности',
        'Разрешить спор по договору поставки',
        'Разрешить спор по договору подряда',
//        'Разрешить спор по договору оказания услуг',
//        'Разрешить спор по договору аренды'
    ),
//    'fullControl' => '120 000',
//    'optimus' => array('price' => '19 000', 'oldPrice' => '29 000'),
//    'minimus' => '4 900',
    'reviews' => array(
        1 => array(
